...
export declare const replaceStr: (string: string, search: Readonly<{
    [key: string]: string;
}>) => string;
...
export declare const sumTime: (...time: readonly string[]) => string;
export declare const getYearWeek: (date: string | number | Date) => number;
export declare const shuffle: <T>(array: readonly T[]) => T[];
export declare const getPermutations: <T>(items: readonly T[]) => T[][];
...
export declare const onSwipe: (element: HTMLElement, callback: (e: TouchEvent, direction: 'left' | 'right' | 'up' | 'down') => void, options?: Readonly<{
    swipeLength?: number;
}>) => void;
